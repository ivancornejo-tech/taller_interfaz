      ...
      const { classes, registro, handleChange, handleChangeObject } = this.props;
        return (
            <Grid container spacing={4}>
                ...
                <Grid item xs={12} md={4}>
                    <TextField required className={classes.field} id={"primerApellido"} label={"primerApellido"} value={registro.primerApellido}
                        onChange={(e) => handleChange('primerApellido', e)}
                        error={!registro.primerApellido || registro.primerApellido.length === 0}
                    />
                </Grid>
                <Grid item xs={12} md={4}>
                    <TextField required className={classes.field} id={"segundoApellido"} label={"segundoApellido"} value={registro.segundoApellido}
                        onChange={(e) => handleChange('segundoApellido', e)}
                        error={!registro.segundoApellido || registro.segundoApellido.length === 0}
                    />
                </Grid>
                <Grid item xs={12} md={4}>
                    <TextField required className={classes.field} id={"rfc"} label={"rfc"} value={registro.rfc}
                        onChange={(e) => handleChange('rfc', e)}
                        error={registro.rfc.match(regRFC) == null}
                    />
                </Grid>
                <Grid item xs={12} md={4}>
                    <TextField required className={classes.field} id={"curp"} label={"curp"} value={registro.curp}
                ...
                <Grid item xs={12} md={4}>
                    <FormControl component="fieldset" className={classes.formControl}>
                        <FormLabel component="legend">Tipo área</FormLabel>
                        <FormGroup>
                            {
                                tiposArea.map(ta => {
                ...
                <Grid item xs={12} md={4}>
                    <FormControl component="fieldset" className={classes.formControl}>
                        <FormLabel component="legend">Niveles de responsabilidad</FormLabel>
                        <FormGroup>
                            {
