                    ...
                    <Grid item xs={12} className={classes.container}>
                        ...
                        <Grid container spacing={3} className={classes.root} xs={12}>
                            ...
                            <Grid item xs={12} md={4}>
                                ...
                                <Typography variant={"h6"}>
                                    {
                                        servidor.superiorInmediato ? servidor.superiorInmediato.nombres
                            ...
                            <Grid item xs={12} md={4}>
                                ...
                                <Typography className={classes.dataCard}>
                                    {servidor.superiorInmediato.puesto.nombre ? servidor.superiorInmediato.puesto.nombre : 'Dato no proporcionado'}
                                </Typography>
                            </Grid>
